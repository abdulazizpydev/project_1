...
AWS_S3_OBJECT_PARAMETRS = AWS_S3_OBJECT_PARAMETRS
AWS_QUERYSTRING_EXPIRE = 3600

STATIC_URL = 'https://%s/%s/' % (AWS_ENDPOINT, AWS_STORAGE_BUCKET_NAME)
MEDIA_URL = 'https://%s/%s/' % (AWS_ENDPOINT, AWS_STORAGE_BUCKET_NAME)
